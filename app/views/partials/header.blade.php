                        ...
                        <nav class="nav put-right">
                            <ul class="sf-menu">
                                ...
                                <li @yield('current_about')><a style="cursor: pointer">Patients</a>
                                    <ul>
                                        <li><a href="appointments">Operation Bookings</a></li>
                                        ...
                                        <li><a href="app_proc">Operation Procedures</a></li>
                                    </ul>
                                </li>
                                <li @yield('current_contacts')><a style="cursor: pointer">Billing</a>
                                    <ul>
                                        <li><a href="app_check_fee">Add Operation Fee</a></li>
                                        <li><a href="app_checkup_fee_print">Operation Fee Invoice</a></li>
                                    </ul>
                                </li>
                    ...
                    <div class="grid_12">
                        ...
                        <nav class="nav put-right">
                            <ul class="sf-menu">
                                ...
                                <li @yield('current_contacts')><a href="appointments">Operation Bookings</a></li>
                                <li><a href="/logout">Logout</a></li>
                            </ul>
                        </nav>
                    </div>
